...
const SignupScreen = ({ navigation }: { navigation: any }) => {
  ...
  const handleSignup = async () => {
    try {
      const response = await axios.post('http://workerapi-env.eba-srhtzvap.ap-southeast-2.elasticbeanstalk.com/api/employees/singup', {
        firstName,
        email,
        phone,
        password,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.rowContainer, { flexDirection: Platform.OS === 'web' ? 'row' : 'column' }]}>
